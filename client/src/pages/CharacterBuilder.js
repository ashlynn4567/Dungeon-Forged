...
export default function CharacterBuilder() {
  ...
  <header>
    <section class="charname">
      <label for="charname">Character Name</label><input name="charname" placeholder="Eswyn Crompul" />
    </section>
    <section class="misc">
      <ul>
        <li>
          <label for="classlevel">Class and Level</label><input name="classlevel" placeholder="Barbarian 20" />
        </li>
        <li>
          <label for="background">Background</label><input name="background" placeholder="Folk" />
        </li>
        <li>
          <label for="playername">Player Name</label><input></input> 
        </li>
        <li>
          <label for="race">Race</label><input name="race" placeholder="Dragonborn" />
        </li>
        <li>
          <label for="alignment">Alignment</label><input name="alignment" placeholder="Chaotic Neutral" />
        </li>
        <li>
          <label for="experiencepoints">Experience Points</label><input name="experiencepoints" placeholder="355,000" />
        </li>
      </ul>
    </section>
  </header>
  <main>
    <section>
      <section class="attributes">
        <div class="scores">
          <ul>
            <li>
              <div class="score">
                <label for="Strengthscore">Strength</label><input name="Strengthscore" placeholder="29" />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Dexterityscore">Dexterity</label><input name="Dexterityscore" placeholder="11" />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Constitutionscore">Constitution</label><input name="Constitutionscore" placeholder="22" />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Wisdomscore">Wisdom</label><input name="Wisdomscore" placeholder="9" />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Intelligencescore">Intelligence</label><input name="Intelligencescore" placeholder="11" />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Charismascore">Charisma</label><input name="Charismascore" placeholder="18" />
              </div>
              <div class="modifier">
        ...
        <div class="attr-applications">
          ...
          <div class="proficiencybonus box">
            ...
            <input name="proficiencybonus" placeholder="+6" />
          </div>
      ...
      <div class="passive-perception box">
        ...
        <input name="passiveperception" placeholder="12" />
      </div>
    ...
    <section>
      <section class="combat">
        <div class="armorclass">
          <div>
            <label for="ac">Armor Class</label><input name="ac" placeholder="26" type="text" />
          </div>
        </div>
        ...
        <div class="speed">
          <div>
            <label for="speed">Speed</label><input name="speed" placeholder="35" type="text" />
          </div>
        </div>
        <div class="hp">
          <div class="regular">
            <div class="max">
              <label for="maxhp">Hit Point Maximum</label><input name="maxhp" placeholder="120" type="text" />
            </div>
            <div class="current">
        ...
        <div class="hitdice">
          <div>
            <div class="total">
              <label for="totalhd">Total</label><input name="totalhd" placeholder="4d12" type="text" />
            </div>
            <div class="remaining">
